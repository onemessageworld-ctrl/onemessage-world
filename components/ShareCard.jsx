export function generateShareCard({ name, country, messageNumber, lang }) {
  return new Promise((resolve) => {
    ...
    const subs={en:"Your message is sealed",ar:"رسالتك مختومة",pt:"Sua mensagem está selada",es:"Tu mensaje está sellado",fr:"Votre message est scellé",de:"Ihre Nachricht ist versiegelt",it:"Il tuo messaggio è sigillato",zh:"你的留言已封存",ja:"メッセージが封印されました",ko:"메시지가 봉인되었습니다",hi:"आपका संदेश सील है",tr:"Mesajın mühürlendi",ru:"Ваше послание запечатано",id:"Pesanmu telah disegel"};
